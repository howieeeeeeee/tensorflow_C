...
tf.app.flags.DEFINE_string('graph_file', '/xhome/tx_zhiwei/facial_age_results/freeze_test/frozen_graph.pb', "")
...
if __name__ == '__main__':
    result = getResult('/xhome/tx_zhiwei/test_pic/liang.jpg')
